...
/**
 * Stat that computes the current best solution's transportation cost.
 */
public class CurrentMinCostCustomStat  implements Stat {
    /**
     ...
     */
    public CurrentMinCostCustomStat(Integer decimalNumber, ArrayList<Facility> facilities) {
        this.header = new ArrayList<>(){{add("CurrentMinCost");}};
     ...
     * cost of the colony's best solution.
     *
    ...
    public ArrayList<String> apply(World world, Colony colony, Object... statArgs) {
        ...
        String str = String.format(this.decimalFormat,cost);
