...
/**
 * Stat that computes the colony's current best solution transportation time.
 */
public class CurrentMinTimeCustomStat implements Stat {
    /**
     ...
     */
    public CurrentMinTimeCustomStat(Integer decimalNumber, ArrayList<Facility> facilities) {
        this.header = new ArrayList<>(){{add("CurrentMinTime");}};
    ...
    /**
     * This ArrayList of strings computes the values for this stat. In this case, the stat returns the transportation
     * time of the colony's best solution.
     *
    ...
    public ArrayList<String> apply(World world, Colony colony, Object... statArgs) {
        ...
        String str = String.format(this.decimalFormat,time);
