...
public class ImageStat implements Stat {
     ...
     */
    private final HashMap<Integer, RunSparseTspOptimization.tspNode> worldMap;
    /**
     ...
     */
    public ImageStat( HashMap<Integer, RunSparseTspOptimization.tspNode> worldMap, Integer scale) {
    ...
    private Image getImage(World world, Colony colony, Integer generation){
        ...
        graphics2D.setFont(new Font(graphics2D.getFont().getName(),graphics2D.getFont().getStyle(),this.imageHeight/20));
